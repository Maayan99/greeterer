...
export const businessCardTemplates: CardTemplate[] = [
  ...
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 200">
      ...
      <circle cx="200" cy="100" r="80" fill="#fbbf24" opacity="0.3"/>
      <circle cx="200" cy="100" r="60" fill="#f59e0b" opacity="0.3"/>
      <circle cx="200" cy="100" r="40" fill="#d97706" opacity="0.3"/>
      <path d="M20,100 Q200,20 380,100" fill="none" stroke="#b45309" stroke-width="2"/>
    </svg>`,
    fields: [
      { id: 'name', type: 'text', content: '{name}', x: 40, y: 60, fontSize: 32, color: '#b45309' },
      { id: 'title', type: 'text', content: '{title}', x: 40, y: 100, fontSize: 20, color: '#d97706' },
      { id: 'phone', type: 'text', content: '{phone}', x: 40, y: 140, fontSize: 16, color: '#92400e' },
      { id: 'email', type: 'text', content: '{email}', x: 40, y: 165, fontSize: 16, color: '#92400e' },
      { id: 'website', type: 'text', content: '{website}', x: 200, y: 165, fontSize: 16, color: '#92400e' }
    ]
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 200">
      ...
      <circle cx="200" cy="100" r="50" fill="none" stroke="#e5e7eb" stroke-width="1"/>
    </svg>`,
    fields: [
      { id: 'name', type: 'text', content: '{name}', x: 40, y: 60, fontSize: 32, color: '#f9fafb' },
      { id: 'title', type: 'text', content: '{title}', x: 40, y: 100, fontSize: 20, color: '#d1d5db' },
      { id: 'phone', type: 'text', content: '{phone}', x: 40, y: 140, fontSize: 16, color: '#9ca3af' },
      { id: 'email', type: 'text', content: '{email}', x: 40, y: 165, fontSize: 16, color: '#9ca3af' },
  ...
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 200">
      ...
      <path d="M30,100 Q100,50 200,100 T370,100" fill="none" stroke="#047857" stroke-width="2"/>
    </svg>`,
    fields: [
      { id: 'name', type: 'text', content: '{name}', x: 40, y: 60, fontSize: 32, color: '#047857' },
      { id: 'title', type: 'text', content: '{title}', x: 40, y: 100, fontSize: 20, color: '#059669' },
      { id: 'phone', type: 'text', content: '{phone}', x: 40, y: 140, fontSize: 16, color: '#065f46' },
      { id: 'email', type: 'text', content: '{email}', x: 40, y: 165, fontSize: 16, color: '#065f46' },
      { id: 'website', type: 'text', content: '{website}', x: 200, y: 165, fontSize: 16, color: '#065f46' }
    ]
  },
  {
    id: 'tech-circuit',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 200">
      ...
      <rect x="20" y="20" width="360" height="160" fill="rgba(15,23,42,0.7)" rx="10" ry="10"/>
    </svg>`,
    fields: [
      { id: 'name', type: 'text', content: '{name}', x: 30, y: 60, fontSize: 32, color: '#f9fafb' },
      { id: 'title', type: 'text', content: '{title}', x: 30, y: 100, fontSize: 20, color: '#60a5fa' },
      { id: 'phone', type: 'text', content: '{phone}', x: 30, y: 140, fontSize: 16, color: '#93c5fd' },
      { id: 'email', type: 'text', content: '{email}', x: 30, y: 165, fontSize: 16, color: '#93c5fd' },
      { id: 'website', type: 'text', content: '{website}', x: 200, y: 165, fontSize: 16, color: '#93c5fd' }
    ]
  },
  {
    id: 'artistic-splash',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 200">
      ...
      <path d="M20 100 Q100 50 200 100 T380 100" fill="none" stroke="#4b5563" stroke-width="2"/>
      <path d="M20 120 Q100 70 200 120 T380 120" fill="none" stroke="#4b5563" stroke-width="2"/>
    </svg>`,
    fields: [
      { id: 'name', type: 'text', content: '{name}', x: 40, y: 60, fontSize: 32, color: '#4b5563' },
      { id: 'title', type: 'text', content: '{title}', x: 40, y: 100, fontSize: 20, color: '#6b7280' },
      { id: 'phone', type: 'text', content: '{phone}', x: 40, y: 140, fontSize: 16, color: '#9ca3af' },
      { id: 'email', type: 'text', content: '{email}', x: 40, y: 165, fontSize: 16, color: '#9ca3af' },
      { id: 'website', type: 'text', content: '{website}', x: 200, y: 165, fontSize: 16, color: '#9ca3af' }
    ]
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 200">
      ...
      <text x="20" y="80" font-family="Arial" font-size="60" font-weight="bold" fill="#1f2937">MINIMAL</text>
      <rect x="20" y="110" width="100" height="2" fill="#4b5563"/>
      <rect x="280" y="110" width="100" height="2" fill="#4b5563"/>
      <circle cx="200" cy="150" r="30" fill="#e5e7eb"/>
    </svg>`,
    fields: [
